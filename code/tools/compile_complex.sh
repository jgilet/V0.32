...
echo "# "
echo "# Use of model and model_build to create $EXE"
echo "# "
...
dirsrcalt=$(echo $dirh"/../model_build/src")
dirincalt=$(echo $dirh"/../model_build/inc")
...
cp $dirc/code/mkfile/$EXE $dirc/code/exe/$EXE
...
echo "# "
echo "# `ls -al $dirc/code/exe/$EXE`"
echo "# $dirc/code/exe/$EXE has been created."
echo "###########################"
