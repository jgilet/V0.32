...
!     MODIFIED FOR THE SHELFBREAK (SLOPE in Y) TOPOGRAPHY               
      integer i,j,k,n 
      real*8 ::const,dz,Jx(NI,NK),Jy(0:NJ,0:NK),Jy2(NJ,0:NK),   &
...
!     const = (approx)  1.d-3                                           
      ...
      call evalrho(rho,n) 
!      print*,'n=',n
!      print*,'rgrad_song', rho(1,NJ,NK),rho(1,NJ+1,NK)
!      print*,'rgrad_song', T(1,NJ,NK,0),T(1,NJ+1,NK,1)
!      print*,'rgrad_song', S(1,NJ,NK,0),S(1,NJ+1,NK,1)
!      do k=1,NK                                                        
!         do j=1,NJ                                                     
!            do i=1,NI                                                  
!               rho(i,j,k)= s(i,j,k,n)                                  
...
!         end if                                                        
      ...
      print*,'rgrad_song 61', rho(1,NJ,NK),rho(1,NJ+1,NK)
!                                                                       
!                                                                       
...
!     periodic-ew boundaries                                            
     ...
     &              0.5d0*const*(Jx(i,k+1) +Jx(i,k))                    
      ...
      print*,'rgrad_song 91', rho(1,NJ,NK),rho(1,NJ+1,NK)
...
! Solid boundaries                                                      
     ...
     &           *( Jy(j,k) + Jy(j-1,k))                                
      ...
      return 
      print*,'rgrad_song 170', rho(1,NJ,NK),rho(1,NJ+1,NK)
