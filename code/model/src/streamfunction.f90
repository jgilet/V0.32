subroutine streamfunction(rhobar,n2bar,psiv,psiw,by,bybar,bzbar,     &
...
!     BC psi =0 on all boundaries                                       
     ...
     &     wpvbar(NJ,NK),pvbar(NJ,NK),pv1(NI,NJ,NK),                    &
     &     pv2(NI,NJ,NK),pv3(NI,NJ,NK),pv1bar(NJ,NK),pv2bar(NJ,NK),     &
...
!     WL= eps*delta*UL                                                  
      ...
      call pvcalc(n,pv1,pv2,pv3,vor1,vor2,vor3) 
