...
!                                                                       
     ...
     &        + sumcxf(i,j) - sumcxf(im1,j)                             &
     &        + sumcyf(i,j) - sumcyf(i,j-1)                             &
     &        + const*(sumuf(i,j) - sumuf(im1,j)                        &
     &        + sumvf(i,j) - sumvf(i,j-1) ) )                           &
     &        -gpkinv*( sumsif(i,j) - sumsif(im1,j) +                   &
     &        sumsjf(i,j) - sumsjf(i,j-1) )                             &
     &        - const*( sumhxn(i,j) - sumhxn(im1,j) +                   &
     &        sumhyn(i,j) - sumhyn(i,j-1) )                             
!                                                                       
         chf(1,i,j)= -edtg*J2d(i,j)*dtinv - (sumgi(i,j,1) +             &
     &        sumgi(im1,j,1)+sumgj(i,j,2) +sumgj(i,j-1,2))              
         chf(2,i,j)= (sumgi(i,j,1) +0.25*(sumgj(i,j,1)                  &
     &        -sumgj(i,j-1,1)))                                         
         chf(3,i,j)= (sumgi(im1,j,1) +0.25*(-sumgj(i,j,1)               &
     &        +sumgj(i,j-1,1)) )                                        
         chf(4,i,j)= (sumgj(i,j,2) +0.25*(-sumgi(im1,j,2)               &
     &        +sumgi(i,j,2)) )                                          
...
!         do j=2,NJ                                                     
!            do i=2,NI                                                  
!               v1(i,j,k)= sumcxf(i,j) - sumcxf(im1,j)                  
!               v2(i,j,k)= sumcyf(i,j) - sumcyf(i,j-1)                  
!c               v3(i,j,k)= grpjfc(i,j,k)                               
!               v4(i,j,k)= sjfc(i,j,k)                                  
!               v5(i,j,k)= sumsjf(i,j)                                  
!            end do                                                     
!         end do                                                        
